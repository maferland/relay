...
export async function transition(id: string, to: State, note: string): Promise<UiTask> {
...
export async function pollChanges(since: number, signal: AbortSignal): Promise<{ tasks: UiTask[]; now: number }> {
